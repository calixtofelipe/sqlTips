CREATE OR REPLACE PROCEDURE SANKHYA.STP_MEGA(P_QUEIMA NUMBER)
AS
...
--ERRO SE NÃO INFORMAR O NUMERO CERTO PARA QUEIMAR DEZENA
 IF P_QUEIMA NOT IN (0,1,11,21,31,41,51) THEN
 ...
 SELECT ROUND(DBMS_RANDOM.VALUE(1,60)) INTO P_DEZENA1
   FROM DUAL;
  ...
  SELECT ROUND(DBMS_RANDOM.VALUE(1,60)) INTO P_DEZENA2
  FROM DUAL;
  ...
  SELECT ROUND(DBMS_RANDOM.VALUE(1,60)) INTO P_DEZENA3
  FROM DUAL;
  ...
  SELECT ROUND(DBMS_RANDOM.VALUE(1,60)) INTO P_DEZENA4
  FROM DUAL;
  ...
  SELECT ROUND(DBMS_RANDOM.VALUE(1,60)) INTO P_DEZENA5
  FROM DUAL;
   WHILE P_DEZENA5 >=P_QUEIMA AND P_DEZENA5<=P_QUEIMA+9  LOOP
    SELECT ROUND(DBMS_RANDOM.VALUE(1,60)) INTO P_DEZENA5
     FROM DUAL;
    
  END LOOP;
  
  SELECT ROUND(DBMS_RANDOM.VALUE(1,60)) INTO P_DEZENA6
  FROM DUAL;
   WHILE P_DEZENA6 >=P_QUEIMA AND P_DEZENA6<=P_QUEIMA+9 AND P_QUEIMA <> 0
   LOOP
    SELECT ROUND(DBMS_RANDOM.VALUE(1,60)) INTO P_DEZENA6
     FROM DUAL;
  ...
  --VERIFICAR SE DEZENAS ESTAO COM MENOS DE 10 NUMEROS DE DIFERENCA
    IF RETORNA_INTEIRO((P_DEZENA1 - P_DEZENA2)) < 6 
    THEN P_MESMADEZENA1:=1;
    END IF;
    IF RETORNA_INTEIRO(P_DEZENA1 - P_DEZENA3) < 6 
    THEN P_MESMADEZENA2:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA1 - P_DEZENA4) < 6 
    THEN P_MESMADEZENA3:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA1 - P_DEZENA5) < 6 
    THEN P_MESMADEZENA4:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA1 - P_DEZENA6) < 6 
    THEN P_MESMADEZENA5:=1;
    END IF; 
    
        IF RETORNA_INTEIRO((P_DEZENA2 - P_DEZENA1)) < 6 
    THEN P_MESMADEZENA12:=1;
    END IF;
    IF RETORNA_INTEIRO(P_DEZENA2 - P_DEZENA3) < 6 
    THEN P_MESMADEZENA22:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA2 - P_DEZENA4) < 6 
    THEN P_MESMADEZENA32:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA2 - P_DEZENA5) < 6 
    THEN P_MESMADEZENA42:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA2 - P_DEZENA6) < 6 
    THEN P_MESMADEZENA52:=1;
    END IF;
    
    IF RETORNA_INTEIRO((P_DEZENA3 - P_DEZENA1)) < 6 
    THEN P_MESMADEZENA13:=1;
    END IF;
    IF RETORNA_INTEIRO(P_DEZENA3 - P_DEZENA2) < 6 
    THEN P_MESMADEZENA23:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA3 - P_DEZENA4) < 6 
    THEN P_MESMADEZENA33:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA3 - P_DEZENA5) < 6 
    THEN P_MESMADEZENA43:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA3 - P_DEZENA6) < 6 
    THEN P_MESMADEZENA53:=1;
    END IF;
    
    IF RETORNA_INTEIRO((P_DEZENA4 - P_DEZENA1)) < 6 
    THEN P_MESMADEZENA14:=1;
    END IF;
    IF RETORNA_INTEIRO(P_DEZENA4 - P_DEZENA2) < 6 
    THEN P_MESMADEZENA24:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA4 - P_DEZENA3) < 6 
    THEN P_MESMADEZENA34:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA4 - P_DEZENA5) < 6 
    THEN P_MESMADEZENA44:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA4 - P_DEZENA6) < 6 
    THEN P_MESMADEZENA54:=1;
    END IF;
    
    IF RETORNA_INTEIRO((P_DEZENA5 - P_DEZENA1)) < 6 
    THEN P_MESMADEZENA15:=1;
    END IF;
    IF RETORNA_INTEIRO(P_DEZENA5 - P_DEZENA2) < 6 
    THEN P_MESMADEZENA25:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA5 - P_DEZENA3) < 6 
    THEN P_MESMADEZENA35:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA5 - P_DEZENA4) < 6 
    THEN P_MESMADEZENA45:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA5 - P_DEZENA6) < 6 
    THEN P_MESMADEZENA55:=1;
    END IF;
    
    IF RETORNA_INTEIRO((P_DEZENA6 - P_DEZENA1)) < 6 
    THEN P_MESMADEZENA16:=1;
    END IF;
    IF RETORNA_INTEIRO(P_DEZENA6 - P_DEZENA2) < 6 
    THEN P_MESMADEZENA26:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA6 - P_DEZENA3) < 6 
    THEN P_MESMADEZENA36:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA6 - P_DEZENA4) < 6 
    THEN P_MESMADEZENA46:=1;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA6 - P_DEZENA5) < 6 
    THEN P_MESMADEZENA56:=1;
    END IF;
    
    --VERIFICAR SE DEZENAS ESTÃO NO QUADRANTE 1
    SELECT COUNT(1) INTO P_QUADRANTE11                      
      FROM QUADRANTEMEGA Q
    ...
    SELECT COUNT(1) INTO P_QUADRANTE16
      FROM QUADRANTEMEGA Q
     WHERE Q.QUADRANTE1 = P_DEZENA6;
    ...
    SELECT COUNT(1) INTO P_QUADRANTE26
      FROM QUADRANTEMEGA Q
     WHERE Q.QUADRANTE2 = P_DEZENA6;
    ...
    SELECT COUNT(1) INTO P_QUADRANTE36
      FROM QUADRANTEMEGA Q
     WHERE Q.QUADRANTE3 = P_DEZENA6;
    ...
    SELECT COUNT(1) INTO P_QUADRANTE46
      FROM QUADRANTEMEGA Q
     WHERE Q.QUADRANTE4 = P_DEZENA6;
  
  WHILE  (((P_DEZENA1 = P_DEZENA2) OR (P_DEZENA1 = P_DEZENA3) OR (P_DEZENA1 = P_DEZENA4) OR (P_DEZENA1 = P_DEZENA5) OR (P_DEZENA1 = P_DEZENA6))
 OR 
   ((P_DEZENA2 = P_DEZENA3) OR (P_DEZENA2 = P_DEZENA4) OR (P_DEZENA2 = P_DEZENA5) OR (P_DEZENA2 = P_DEZENA6))
 OR 
   ((P_DEZENA3 = P_DEZENA4) OR (P_DEZENA3 = P_DEZENA5) OR (P_DEZENA3 = P_DEZENA6))
    OR 
   ((P_DEZENA4 = P_DEZENA5) OR (P_DEZENA4 = P_DEZENA6))
   OR 
   ((P_DEZENA5 = P_DEZENA6))) 
   OR ((P_MESMADEZENA1+P_MESMADEZENA2+P_MESMADEZENA3+P_MESMADEZENA4+P_MESMADEZENA5) > 3
   OR (P_MESMADEZENA12+P_MESMADEZENA22+P_MESMADEZENA32+P_MESMADEZENA42+P_MESMADEZENA52) > 3
   OR (P_MESMADEZENA13+P_MESMADEZENA23+P_MESMADEZENA33+P_MESMADEZENA43+P_MESMADEZENA53) > 3
   OR (P_MESMADEZENA14+P_MESMADEZENA24+P_MESMADEZENA34+P_MESMADEZENA44+P_MESMADEZENA54) > 3 
   OR (P_MESMADEZENA15+P_MESMADEZENA25+P_MESMADEZENA35+P_MESMADEZENA45+P_MESMADEZENA55) > 3 
   OR (P_MESMADEZENA16+P_MESMADEZENA26+P_MESMADEZENA36+P_MESMADEZENA46+P_MESMADEZENA56) > 3 ) 
   OR --NOT
   (  (P_QUADRANTE11+P_QUADRANTE12+P_QUADRANTE13+P_QUADRANTE14+P_QUADRANTE15+P_QUADRANTE16) >4
   OR (P_QUADRANTE21+P_QUADRANTE22+P_QUADRANTE23+P_QUADRANTE24+P_QUADRANTE25+P_QUADRANTE26) >4   
   OR (P_QUADRANTE31+P_QUADRANTE32+P_QUADRANTE33+P_QUADRANTE34+P_QUADRANTE35+P_QUADRANTE36) >4
   OR (P_QUADRANTE41+P_QUADRANTE42+P_QUADRANTE43+P_QUADRANTE44+P_QUADRANTE45+P_QUADRANTE46) >4)
   OR ((P_DEZENA6 < 25) OR (P_DEZENA1 > 40) OR (P_DEZENA2 >50) OR (P_DEZENA5 <10))
   OR (P_DEZENA1 * P_DEZENA2 * P_DEZENA3 * P_DEZENA4 * P_DEZENA5 * P_DEZENA6) < 56000
   OR (P_DEZENA1 * P_DEZENA2 * P_DEZENA3 * P_DEZENA4 * P_DEZENA5 * P_DEZENA6) > 20023799000
   OR (POWER((
     (POWER(P_DEZENA1 - ((P_DEZENA1 + P_DEZENA2 + P_DEZENA3 + P_DEZENA4 + P_DEZENA5 + P_DEZENA6)/6),2) +
      POWER(P_DEZENA2 - ((P_DEZENA1 + P_DEZENA2 + P_DEZENA3 + P_DEZENA4 + P_DEZENA5 + P_DEZENA6)/6),2) +
      POWER(P_DEZENA3 - ((P_DEZENA1 + P_DEZENA2 + P_DEZENA3 + P_DEZENA4 + P_DEZENA5 + P_DEZENA6)/6),2) +
      POWER(P_DEZENA4 - ((P_DEZENA1 + P_DEZENA2 + P_DEZENA3 + P_DEZENA4 + P_DEZENA5 + P_DEZENA6)/6),2) +
      POWER(P_DEZENA5 - ((P_DEZENA1 + P_DEZENA2 + P_DEZENA3 + P_DEZENA4 + P_DEZENA5 + P_DEZENA6)/6),2) +
      POWER(P_DEZENA6 - ((P_DEZENA1 + P_DEZENA2 + P_DEZENA3 + P_DEZENA4 + P_DEZENA5 + P_DEZENA6)/6),2)) 
      /5),0.5) < 5 OR POWER((
     (POWER(P_DEZENA1 - ((P_DEZENA1 + P_DEZENA2 + P_DEZENA3 + P_DEZENA4 + P_DEZENA5 + P_DEZENA6)/6),2) +
      POWER(P_DEZENA2 - ((P_DEZENA1 + P_DEZENA2 + P_DEZENA3 + P_DEZENA4 + P_DEZENA5 + P_DEZENA6)/6),2) +
      POWER(P_DEZENA3 - ((P_DEZENA1 + P_DEZENA2 + P_DEZENA3 + P_DEZENA4 + P_DEZENA5 + P_DEZENA6)/6),2) +
 ...
 LOOP  
  ...
  SELECT ROUND(DBMS_RANDOM.VALUE(1,60)) INTO P_DEZENA5
  FROM DUAL;
   WHILE P_DEZENA5 >=P_QUEIMA AND P_DEZENA5<=P_QUEIMA+9 AND P_QUEIMA <> 0
    LOOP
    SELECT ROUND(DBMS_RANDOM.VALUE(1,60)) INTO P_DEZENA5
     FROM DUAL;
...
END LOOP;
    ...
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA1 - P_DEZENA6) < 10 
    THEN P_MESMADEZENA5:=1;
    ELSE P_MESMADEZENA5:=0;
    END IF; 
    ...
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA2 - P_DEZENA6) < 10 
    THEN P_MESMADEZENA52:=1;
    ELSE P_MESMADEZENA52:=0;
    END IF; 
    ...
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA3 - P_DEZENA6) < 10 
    THEN P_MESMADEZENA53:=1;
    ELSE P_MESMADEZENA53:=0;
    END IF;    
    ...
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA4 - P_DEZENA6) < 10 
    THEN P_MESMADEZENA54:=1;
    ELSE P_MESMADEZENA54:=0;
    END IF; 
    ...
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA5 - P_DEZENA6) < 10 
    THEN P_MESMADEZENA55:=1;
    ELSE P_MESMADEZENA55:=0;
    END IF; 
    
    IF RETORNA_INTEIRO((P_DEZENA6 - P_DEZENA1)) < 10 
    THEN P_MESMADEZENA16:=1;
    ELSE P_MESMADEZENA16:=0;
    END IF;
    IF RETORNA_INTEIRO(P_DEZENA6 - P_DEZENA2) < 10 
    THEN P_MESMADEZENA26:=1;
    ELSE P_MESMADEZENA26:=0;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA6 - P_DEZENA3) < 10 
    THEN P_MESMADEZENA36:=1;
    ELSE P_MESMADEZENA36:=0;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA6 - P_DEZENA4) < 10 
    THEN P_MESMADEZENA46:=1;
    ELSE P_MESMADEZENA46:=0;
    END IF; 
    IF RETORNA_INTEIRO(P_DEZENA6 - P_DEZENA5) < 10 
    THEN P_MESMADEZENA56:=1;
    ELSE P_MESMADEZENA56:=0;
    END IF; 
...
--   END LOOP;
     ...
     INSERT INTO MEGASENA (DEZENA1,DEZENA2,DEZENA3,DEZENA4,DEZENA5,DEZENA6)
        VALUES         (P_DEZENA1,P_DEZENA2,P_DEZENA3,P_DEZENA4,P_DEZENA5,P_DEZENA6);
        COMMIT;
         ...
         SELECT NVL(MAX(NROSORTEIO),0) INTO P_NROSORTEIO
          ...
          WHERE G.DEZENA1=P_DEZENA1
            ...
            --AND G.NROSORTEIO=1728
            ;
            
        IF P_NROSORTEIO > 0 THEN
        RAISE_APPLICATION_ERROR(-20101,'GANHOU NA MEGA'||P_NROSORTEIO);
        END IF;
